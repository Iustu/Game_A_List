...
export class jogoService {
  ...
  findAll() {
    return this.http.get<jogo[]>(environment.apiUrl + '/jogos');
  }

  create(jogo:jogo){
    return this.http.post<jogo>(environment.apiUrl + '/jogos', jogo);
  }

  findById(id: string) {
    return this.http.get<jogo>(environment.apiUrl + '/jogos' + '/' + id);
  }

  update(id: string, jogo:jogo) {
    return this.http.put<jogo>(environment.apiUrl + '/jogos' + '/' + id, jogo);
  }
